      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="border-border bg-card">
          ...
          <CardContent className="space-y-4">
            {[
              { id: 1, title: `My ${currentYear} Predictions`, unlocks: `Dec 31, ${currentYear}`, stakes: 45 },
              { id: 2, title: "Secret Recipe Reveal", unlocks: `Aug 15, ${currentYear}`, stakes: 23 },
              { id: 3, title: "Investment Advice", unlocks: `Nov 1, ${currentYear}`, stakes: 67 },
            ].map((capsule) => (
              <div
                key={capsule.id}
